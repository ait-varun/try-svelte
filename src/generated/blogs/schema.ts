...
export type UniformResourceIdentifiable = (Category | ContentType | User | MediaItem | Page | Post | PostFormat | Tag) & { __isUnion?: true }
...
export type MenuItemLinkable = (Category | Page | Post | Tag) & { __isUnion?: true }
...
/** The template assigned to a node of content */
export type ContentTemplate = (DefaultTemplate | PageTemplateCapabilities | PageTemplateAboutUs | PageTemplateBio | Template_BlogDetail | Template_Blog | Template_Build | PageTemplateCaseStudy | PageTemplateContactUs | PageTemplateDesignFAQ | PageTemplateDiscoveryFAQ | PageTemplateFAQ | PageTemplateDevelopmentFAQ | Template_PageFlexibleContentLayout | Template_GcaptainNew | Template_GcaptainLandingPage | PageTemplateGeneralFAQ | Template_Home | Template_Slocal | PageTemplateMarketingFAQ | PageTemplatePrivacyPolicy | Template_Service | Template_StudyCase) & { __isUnion?: true }
...
export interface PostTypeSEO {
    breadcrumbs: ((SEOPostTypeBreadcrumbs | null)[] | null)
    canonical: (Scalars['String'] | null)
    cornerstone: (Scalars['Boolean'] | null)
    focuskw: (Scalars['String'] | null)
    fullHead: (Scalars['String'] | null)
    metaDesc: (Scalars['String'] | null)
    metaKeywords: (Scalars['String'] | null)
    metaRobotsNofollow: (Scalars['String'] | null)
    metaRobotsNoindex: (Scalars['String'] | null)
    opengraphAuthor: (Scalars['String'] | null)
    opengraphDescription: (Scalars['String'] | null)
    opengraphImage: (MediaItem | null)
    opengraphModifiedTime: (Scalars['String'] | null)
    opengraphPublishedTime: (Scalars['String'] | null)
    opengraphPublisher: (Scalars['String'] | null)
    opengraphSiteName: (Scalars['String'] | null)
    opengraphTitle: (Scalars['String'] | null)
    opengraphType: (Scalars['String'] | null)
    opengraphUrl: (Scalars['String'] | null)
    readingTime: (Scalars['Float'] | null)
    schema: (SEOPostTypeSchema | null)
    title: (Scalars['String'] | null)
...
export interface SEOPostTypeSchema {
    articleType: ((Scalars['String'] | null)[] | null)
    pageType: ((Scalars['String'] | null)[] | null)
    raw: (Scalars['String'] | null)
...
export type PostConnection = (UserToPostConnection | PostFormatToPostConnection | PostToRevisionConnection | TagToPostConnection | CategoryToPostConnection | RootQueryToPostConnection) & { __isUnion?: true }


/** Edge between a Node and a connected post */
export type PostConnectionEdge = (PostFormatToPostConnectionEdge | PostToPreviewConnectionEdge | PostToRevisionConnectionEdge | TagToPostConnectionEdge | UserToPostConnectionEdge | CategoryToPostConnectionEdge | RootQueryToPostConnectionEdge) & { __isUnion?: true }
...
export interface PostToCategoryConnectionEdge {
    ...
    isPrimary: (Scalars['Boolean'] | null)
    /** The item at the end of the edge */
    node: Category
...
export type PostConnectionPageInfo = (PostFormatToPostConnectionPageInfo | PostToRevisionConnectionPageInfo | TagToPostConnectionPageInfo | UserToPostConnectionPageInfo | CategoryToPostConnectionPageInfo | RootQueryToPostConnectionPageInfo) & { __isUnion?: true }
...
export type TermNodeConnectionPageInfo = (PostToTermNodeConnectionPageInfo | RootQueryToTermNodeConnectionPageInfo) & { __isUnion?: true }
...
export interface SEOUser {
    breadcrumbTitle: (Scalars['String'] | null)
    canonical: (Scalars['String'] | null)
    fullHead: (Scalars['String'] | null)
    ...
    schema: (SEOUserSchema | null)
    social: (SEOUserSocial | null)
    title: (Scalars['String'] | null)
    twitterDescription: (Scalars['String'] | null)
    twitterImage: (MediaItem | null)
    twitterTitle: (Scalars['String'] | null)
...
export interface SEOUserSocial {
    ...
    mySpace: (Scalars['String'] | null)
    pinterest: (Scalars['String'] | null)
    soundCloud: (Scalars['String'] | null)
    twitter: (Scalars['String'] | null)
    wikipedia: (Scalars['String'] | null)
    youTube: (Scalars['String'] | null)
...
export type MenuLocationEnum = 'MENU_1'
...
export type MenuItemObjectUnion = (Post | Page | Category | Tag) & { __isUnion?: true }
...
export interface SEOConfig {
    ...
    contentTypes: (SEOContentTypes | null)
    meta: (SEOGlobalMeta | null)
    openGraph: (SEOOpenGraph | null)
    redirects: ((SEORedirect | null)[] | null)
    schema: (SEOSchema | null)
    social: (SEOSocial | null)
    webmaster: (SEOWebmaster | null)
...
export interface SEOBreadcrumbs {
    archivePrefix: (Scalars['String'] | null)
    boldLast: (Scalars['Boolean'] | null)
    enabled: (Scalars['Boolean'] | null)
    homeText: (Scalars['String'] | null)
    notFoundText: (Scalars['String'] | null)
    prefix: (Scalars['String'] | null)
    searchPrefix: (Scalars['String'] | null)
    separator: (Scalars['String'] | null)
    showBlogPage: (Scalars['Boolean'] | null)
...
export interface SEOContentTypes {
    mediaItem: (SEOContentType | null)
    page: (SEOContentType | null)
    post: (SEOContentType | null)
...
export interface SEOContentType {
    archive: (SEOContentTypeArchive | null)
    metaDesc: (Scalars['String'] | null)
    metaRobotsNoindex: (Scalars['Boolean'] | null)
    schema: (SEOPageInfoSchema | null)
    schemaType: (Scalars['String'] | null)
    title: (Scalars['String'] | null)
...
export interface SEOContentTypeArchive {
    archiveLink: (Scalars['String'] | null)
    breadcrumbTitle: (Scalars['String'] | null)
    fullHead: (Scalars['String'] | null)
    hasArchive: (Scalars['Boolean'] | null)
    metaDesc: (Scalars['String'] | null)
    metaRobotsFollow: (Scalars['String'] | null)
    metaRobotsIndex: (Scalars['String'] | null)
    metaRobotsNofollow: (Scalars['Boolean'] | null)
    metaRobotsNoindex: (Scalars['Boolean'] | null)
    title: (Scalars['String'] | null)
...
export interface SEOGlobalMeta {
    author: (SEOGlobalMetaAuthor | null)
    config: (SEOGlobalMetaConfig | null)
    date: (SEOGlobalMetaDate | null)
    homepage: (SEOGlobalMetaHome | null)
    notFound: (SEOGlobalMeta404 | null)
...
export interface SEOGlobalMeta404 {
    breadcrumb: (Scalars['String'] | null)
    title: (Scalars['String'] | null)
...
export interface SEOOpenGraph {
    ...
    frontPage: (SEOOpenGraphFrontPage | null)
...
export interface SEOSchema {
    companyLogo: (MediaItem | null)
    companyName: (Scalars['String'] | null)
    companyOrPerson: (Scalars['String'] | null)
    homeUrl: (Scalars['String'] | null)
    inLanguage: (Scalars['String'] | null)
    logo: (MediaItem | null)
    personLogo: (MediaItem | null)
    personName: (Scalars['String'] | null)
    siteName: (Scalars['String'] | null)
    siteUrl: (Scalars['String'] | null)
    wordpressSiteName: (Scalars['String'] | null)
...
export interface SEOSocial {
    facebook: (SEOSocialFacebook | null)
    instagram: (SEOSocialInstagram | null)
    linkedIn: (SEOSocialLinkedIn | null)
    mySpace: (SEOSocialMySpace | null)
    otherSocials: ((Scalars['String'] | null)[] | null)
    pinterest: (SEOSocialPinterest | null)
    twitter: (SEOSocialTwitter | null)
    wikipedia: (SEOSocialWikipedia | null)
    youTube: (SEOSocialYoutube | null)
...
/** Types of cards */
export type SEOCardType = 'summary' | 'summary_large_image'
...
export interface SEOWebmaster {
    baiduVerify: (Scalars['String'] | null)
    googleVerify: (Scalars['String'] | null)
    msVerify: (Scalars['String'] | null)
    yandexVerify: (Scalars['String'] | null)
...
/** The template assigned to the node */
export interface PageTemplateCapabilities {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateCapabilities'
}


/** The template assigned to the node */
export interface PageTemplateAboutUs {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateAboutUs'
}


/** The template assigned to the node */
export interface PageTemplateBio {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateBio'
}


/** The template assigned to the node */
export interface Template_BlogDetail {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_BlogDetail'
}
...
/** The template assigned to the node */
export interface Template_Build {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_Build'
}


/** The template assigned to the node */
export interface PageTemplateCaseStudy {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateCaseStudy'
}


/** The template assigned to the node */
export interface PageTemplateContactUs {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateContactUs'
}


/** The template assigned to the node */
export interface PageTemplateDesignFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateDesignFAQ'
}


/** The template assigned to the node */
export interface PageTemplateDiscoveryFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateDiscoveryFAQ'
}


/** The template assigned to the node */
export interface PageTemplateFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateFAQ'
}


/** The template assigned to the node */
export interface PageTemplateDevelopmentFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateDevelopmentFAQ'
}


/** The template assigned to the node */
export interface Template_PageFlexibleContentLayout {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_PageFlexibleContentLayout'
}


/** The template assigned to the node */
export interface Template_GcaptainNew {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_GcaptainNew'
}


/** The template assigned to the node */
export interface Template_GcaptainLandingPage {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_GcaptainLandingPage'
}


/** The template assigned to the node */
export interface PageTemplateGeneralFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateGeneralFAQ'
}
...
/** The template assigned to the node */
export interface Template_Slocal {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_Slocal'
}


/** The template assigned to the node */
export interface PageTemplateMarketingFAQ {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplateMarketingFAQ'
}


/** The template assigned to the node */
export interface PageTemplatePrivacyPolicy {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'PageTemplatePrivacyPolicy'
}


/** The template assigned to the node */
export interface Template_Service {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_Service'
}


/** The template assigned to the node */
export interface Template_StudyCase {
    /** The name of the template */
    templateName: (Scalars['String'] | null)
    __typename: 'Template_StudyCase'
}
...
/** The page info SEO details */
export interface SEOPostTypePageInfoGenqlSelection{
    schema?: SEOPageInfoSchemaGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Schema for post type */
export interface SEOPageInfoSchemaGenqlSelection{
    raw?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface ContentTemplateGenqlSelection{
    ...
    on_PageTemplateCapabilities?: PageTemplateCapabilitiesGenqlSelection
    on_PageTemplateAboutUs?: PageTemplateAboutUsGenqlSelection
    on_PageTemplateBio?: PageTemplateBioGenqlSelection
    on_Template_BlogDetail?: Template_BlogDetailGenqlSelection
    on_Template_Blog?: Template_BlogGenqlSelection
    on_Template_Build?: Template_BuildGenqlSelection
    on_PageTemplateCaseStudy?: PageTemplateCaseStudyGenqlSelection
    on_PageTemplateContactUs?: PageTemplateContactUsGenqlSelection
    on_PageTemplateDesignFAQ?: PageTemplateDesignFAQGenqlSelection
    on_PageTemplateDiscoveryFAQ?: PageTemplateDiscoveryFAQGenqlSelection
    on_PageTemplateFAQ?: PageTemplateFAQGenqlSelection
    on_PageTemplateDevelopmentFAQ?: PageTemplateDevelopmentFAQGenqlSelection
    on_Template_PageFlexibleContentLayout?: Template_PageFlexibleContentLayoutGenqlSelection
    on_Template_GcaptainNew?: Template_GcaptainNewGenqlSelection
    on_Template_GcaptainLandingPage?: Template_GcaptainLandingPageGenqlSelection
    on_PageTemplateGeneralFAQ?: PageTemplateGeneralFAQGenqlSelection
    on_Template_Home?: Template_HomeGenqlSelection
    on_Template_Slocal?: Template_SlocalGenqlSelection
    on_PageTemplateMarketingFAQ?: PageTemplateMarketingFAQGenqlSelection
    on_PageTemplatePrivacyPolicy?: PageTemplatePrivacyPolicyGenqlSelection
    on_Template_Service?: Template_ServiceGenqlSelection
    on_Template_StudyCase?: Template_StudyCaseGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface PostTypeSEOGenqlSelection{
    breadcrumbs?: SEOPostTypeBreadcrumbsGenqlSelection
    canonical?: boolean | number
    cornerstone?: boolean | number
    focuskw?: boolean | number
    fullHead?: boolean | number
    metaDesc?: boolean | number
    metaKeywords?: boolean | number
    metaRobotsNofollow?: boolean | number
    metaRobotsNoindex?: boolean | number
    opengraphAuthor?: boolean | number
    opengraphDescription?: boolean | number
    opengraphImage?: MediaItemGenqlSelection
    opengraphModifiedTime?: boolean | number
    opengraphPublishedTime?: boolean | number
    opengraphPublisher?: boolean | number
    opengraphSiteName?: boolean | number
    opengraphTitle?: boolean | number
    opengraphType?: boolean | number
    opengraphUrl?: boolean | number
    readingTime?: boolean | number
    schema?: SEOPostTypeSchemaGenqlSelection
    title?: boolean | number
    twitterDescription?: boolean | number
    twitterImage?: MediaItemGenqlSelection
    twitterTitle?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOPostTypeBreadcrumbsGenqlSelection{
    text?: boolean | number
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The Schema types */
export interface SEOPostTypeSchemaGenqlSelection{
    articleType?: boolean | number
    pageType?: boolean | number
    raw?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface TaxonomySEOGenqlSelection{
    breadcrumbs?: SEOPostTypeBreadcrumbsGenqlSelection
    canonical?: boolean | number
    cornerstone?: boolean | number
    focuskw?: boolean | number
    ...
    opengraphType?: boolean | number
    opengraphUrl?: boolean | number
    schema?: SEOTaxonomySchemaGenqlSelection
    title?: boolean | number
    twitterDescription?: boolean | number
    twitterImage?: MediaItemGenqlSelection
    twitterTitle?: boolean | number
...
/** The Schema types for Taxonomy */
export interface SEOTaxonomySchemaGenqlSelection{
    raw?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface SEOUserGenqlSelection{
    breadcrumbTitle?: boolean | number
    canonical?: boolean | number
    fullHead?: boolean | number
    ...
    schema?: SEOUserSchemaGenqlSelection
    social?: SEOUserSocialGenqlSelection
    title?: boolean | number
    twitterDescription?: boolean | number
    twitterImage?: MediaItemGenqlSelection
    twitterTitle?: boolean | number
...
/** The Schema types for User */
export interface SEOUserSchemaGenqlSelection{
    articleType?: boolean | number
    pageType?: boolean | number
    raw?: boolean | number
    __typename?: boolean | number
...
export interface SEOUserSocialGenqlSelection{
    facebook?: boolean | number
    instagram?: boolean | number
    linkedIn?: boolean | number
    mySpace?: boolean | number
    pinterest?: boolean | number
    soundCloud?: boolean | number
    twitter?: boolean | number
    wikipedia?: boolean | number
    youTube?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO site level configuration data */
export interface SEOConfigGenqlSelection{
    breadcrumbs?: SEOBreadcrumbsGenqlSelection
    contentTypes?: SEOContentTypesGenqlSelection
    meta?: SEOGlobalMetaGenqlSelection
    openGraph?: SEOOpenGraphGenqlSelection
    redirects?: SEORedirectGenqlSelection
    schema?: SEOSchemaGenqlSelection
    social?: SEOSocialGenqlSelection
    webmaster?: SEOWebmasterGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO breadcrumb config */
export interface SEOBreadcrumbsGenqlSelection{
    archivePrefix?: boolean | number
    boldLast?: boolean | number
    enabled?: boolean | number
    homeText?: boolean | number
    notFoundText?: boolean | number
    prefix?: boolean | number
    searchPrefix?: boolean | number
    separator?: boolean | number
    showBlogPage?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO search appearance content types */
export interface SEOContentTypesGenqlSelection{
    mediaItem?: SEOContentTypeGenqlSelection
    page?: SEOContentTypeGenqlSelection
    post?: SEOContentTypeGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO search appearance content types fields */
export interface SEOContentTypeGenqlSelection{
    archive?: SEOContentTypeArchiveGenqlSelection
    metaDesc?: boolean | number
    metaRobotsNoindex?: boolean | number
    schema?: SEOPageInfoSchemaGenqlSelection
...
/** The Yoast SEO search appearance content types fields */
export interface SEOContentTypeArchiveGenqlSelection{
    archiveLink?: boolean | number
    breadcrumbTitle?: boolean | number
    fullHead?: boolean | number
    hasArchive?: boolean | number
    metaDesc?: boolean | number
    metaRobotsFollow?: boolean | number
    metaRobotsIndex?: boolean | number
    metaRobotsNofollow?: boolean | number
    metaRobotsNoindex?: boolean | number
    title?: boolean | number
    __typename?: boolean | number
...
/** The Yoast SEO meta data */
export interface SEOGlobalMetaGenqlSelection{
    author?: SEOGlobalMetaAuthorGenqlSelection
    config?: SEOGlobalMetaConfigGenqlSelection
    date?: SEOGlobalMetaDateGenqlSelection
    homepage?: SEOGlobalMetaHomeGenqlSelection
    notFound?: SEOGlobalMeta404GenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO Author data */
export interface SEOGlobalMetaAuthorGenqlSelection{
    description?: boolean | number
    title?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The Yoast SEO meta config data */
export interface SEOGlobalMetaConfigGenqlSelection{
    separator?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO Date data */
export interface SEOGlobalMetaDateGenqlSelection{
    description?: boolean | number
    title?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The Yoast SEO homepage data */
export interface SEOGlobalMetaHomeGenqlSelection{
    description?: boolean | number
    title?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The Yoast SEO meta 404 data */
export interface SEOGlobalMeta404GenqlSelection{
    breadcrumb?: boolean | number
    title?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Open Graph data */
export interface SEOOpenGraphGenqlSelection{
    defaultImage?: MediaItemGenqlSelection
    frontPage?: SEOOpenGraphFrontPageGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Open Graph Front page data */
export interface SEOOpenGraphFrontPageGenqlSelection{
    description?: boolean | number
    image?: MediaItemGenqlSelection
    title?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast redirect data  (Yoast Premium only) */
export interface SEORedirectGenqlSelection{
...
/** The Yoast SEO schema data */
export interface SEOSchemaGenqlSelection{
    companyLogo?: MediaItemGenqlSelection
    companyName?: boolean | number
    companyOrPerson?: boolean | number
    homeUrl?: boolean | number
    inLanguage?: boolean | number
    logo?: MediaItemGenqlSelection
    personLogo?: MediaItemGenqlSelection
    personName?: boolean | number
    siteName?: boolean | number
    siteUrl?: boolean | number
    wordpressSiteName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO Social media links */
export interface SEOSocialGenqlSelection{
    facebook?: SEOSocialFacebookGenqlSelection
    instagram?: SEOSocialInstagramGenqlSelection
    linkedIn?: SEOSocialLinkedInGenqlSelection
    mySpace?: SEOSocialMySpaceGenqlSelection
    otherSocials?: boolean | number
    pinterest?: SEOSocialPinterestGenqlSelection
    twitter?: SEOSocialTwitterGenqlSelection
    wikipedia?: SEOSocialWikipediaGenqlSelection
    youTube?: SEOSocialYoutubeGenqlSelection
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialFacebookGenqlSelection{
    defaultImage?: MediaItemGenqlSelection
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export interface SEOSocialInstagramGenqlSelection{
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialLinkedInGenqlSelection{
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialMySpaceGenqlSelection{
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialPinterestGenqlSelection{
    metaTag?: boolean | number
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialTwitterGenqlSelection{
...
export interface SEOSocialWikipediaGenqlSelection{
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}

export interface SEOSocialYoutubeGenqlSelection{
    url?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The Yoast SEO  webmaster fields */
export interface SEOWebmasterGenqlSelection{
    baiduVerify?: boolean | number
    googleVerify?: boolean | number
    msVerify?: boolean | number
    yandexVerify?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
/** The template assigned to the node */
export interface PageTemplateCapabilitiesGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateAboutUsGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateBioGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_BlogDetailGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_BlogGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_BuildGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateCaseStudyGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateContactUsGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateDesignFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateDiscoveryFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateDevelopmentFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_PageFlexibleContentLayoutGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_GcaptainNewGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_GcaptainLandingPageGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateGeneralFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_HomeGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_SlocalGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplateMarketingFAQGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface PageTemplatePrivacyPolicyGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_ServiceGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
/** The template assigned to the node */
export interface Template_StudyCaseGenqlSelection{
    /** The name of the template */
    templateName?: boolean | number
    __typename?: boolean | number
    __scalar?: boolean | number
...
export type MutationGenqlSelection = RootMutationGenqlSelection
    ...
    const Connection_possibleTypes: string[] = ['RootQueryToCategoryConnection','TermNodeToEnqueuedScriptConnection','TermNodeToEnqueuedStylesheetConnection','CategoryToAncestorsCategoryConnection','CategoryToCategoryConnection','CategoryToContentNodeConnection','ContentTypeToTaxonomyConnection','TaxonomyToContentTypeConnection','ContentTypeToContentNodeConnection','UserToCommentConnection','CommentToCommentConnection','UserToEnqueuedScriptConnection','UserToEnqueuedStylesheetConnection','UserToMediaItemConnection','HierarchicalContentNodeToContentNodeAncestorsConnection','HierarchicalContentNodeToContentNodeChildrenConnection','ContentNodeToEnqueuedScriptConnection','ContentNodeToEnqueuedStylesheetConnection','MediaItemToCommentConnection','UserToPageConnection','PageToCommentConnection','PageToRevisionConnection','UserToPostConnection','PostToCategoryConnection','PostToCommentConnection','PostToPostFormatConnection','PostFormatToContentNodeConnection','PostFormatToPostConnection','PostToRevisionConnection','PostToTagConnection','TagToContentNodeConnection','TagToPostConnection','PostToTermNodeConnection','UserToRevisionsConnection','UserToUserRoleConnection','CategoryToPostConnection','RootQueryToCommentConnection','RootQueryToContentNodeConnection','RootQueryToContentTypeConnection','RootQueryToMediaItemConnection','MenuToMenuItemConnection','MenuItemToMenuItemConnection','RootQueryToMenuItemConnection','RootQueryToMenuConnection','RootQueryToPageConnection','RootQueryToPluginConnection','RootQueryToPostFormatConnection','RootQueryToPostConnection','RootQueryToEnqueuedScriptConnection','RootQueryToEnqueuedStylesheetConnection','RootQueryToRevisionsConnection','RootQueryToTagConnection','RootQueryToTaxonomyConnection','RootQueryToTermNodeConnection','RootQueryToThemeConnection','RootQueryToUserRoleConnection','RootQueryToUserConnection']
    ...
    const UniformResourceIdentifiable_possibleTypes: string[] = ['Category','ContentType','User','MediaItem','Page','Post','PostFormat','Tag']
    ...
    const SEOPostTypePageInfo_possibleTypes: string[] = ['SEOPostTypePageInfo']
    export const isSEOPostTypePageInfo = (obj?: { __typename?: any } | null): obj is SEOPostTypePageInfo => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOPostTypePageInfo"')
      return SEOPostTypePageInfo_possibleTypes.includes(obj.__typename)
    }
    


    const SEOPageInfoSchema_possibleTypes: string[] = ['SEOPageInfoSchema']
    export const isSEOPageInfoSchema = (obj?: { __typename?: any } | null): obj is SEOPageInfoSchema => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOPageInfoSchema"')
      return SEOPageInfoSchema_possibleTypes.includes(obj.__typename)
    }
    ...
    const MenuItemLinkable_possibleTypes: string[] = ['Category','Page','Post','Tag']
    ...
    const ContentTemplate_possibleTypes: string[] = ['DefaultTemplate','PageTemplateCapabilities','PageTemplateAboutUs','PageTemplateBio','Template_BlogDetail','Template_Blog','Template_Build','PageTemplateCaseStudy','PageTemplateContactUs','PageTemplateDesignFAQ','PageTemplateDiscoveryFAQ','PageTemplateFAQ','PageTemplateDevelopmentFAQ','Template_PageFlexibleContentLayout','Template_GcaptainNew','Template_GcaptainLandingPage','PageTemplateGeneralFAQ','Template_Home','Template_Slocal','PageTemplateMarketingFAQ','PageTemplatePrivacyPolicy','Template_Service','Template_StudyCase']
    ...
    const PostTypeSEO_possibleTypes: string[] = ['PostTypeSEO']
    export const isPostTypeSEO = (obj?: { __typename?: any } | null): obj is PostTypeSEO => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPostTypeSEO"')
      return PostTypeSEO_possibleTypes.includes(obj.__typename)
    }
    


    const SEOPostTypeBreadcrumbs_possibleTypes: string[] = ['SEOPostTypeBreadcrumbs']
    export const isSEOPostTypeBreadcrumbs = (obj?: { __typename?: any } | null): obj is SEOPostTypeBreadcrumbs => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOPostTypeBreadcrumbs"')
      return SEOPostTypeBreadcrumbs_possibleTypes.includes(obj.__typename)
    }
    


    const SEOPostTypeSchema_possibleTypes: string[] = ['SEOPostTypeSchema']
    export const isSEOPostTypeSchema = (obj?: { __typename?: any } | null): obj is SEOPostTypeSchema => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOPostTypeSchema"')
      return SEOPostTypeSchema_possibleTypes.includes(obj.__typename)
    }
    ...
    const PostConnection_possibleTypes: string[] = ['UserToPostConnection','PostFormatToPostConnection','PostToRevisionConnection','TagToPostConnection','CategoryToPostConnection','RootQueryToPostConnection']
    ...
    const PostConnectionEdge_possibleTypes: string[] = ['PostFormatToPostConnectionEdge','PostToPreviewConnectionEdge','PostToRevisionConnectionEdge','TagToPostConnectionEdge','UserToPostConnectionEdge','CategoryToPostConnectionEdge','RootQueryToPostConnectionEdge']
    ...
    const NodeWithExcerpt_possibleTypes: string[] = ['Post']
    ...
    const PostConnectionPageInfo_possibleTypes: string[] = ['PostFormatToPostConnectionPageInfo','PostToRevisionConnectionPageInfo','TagToPostConnectionPageInfo','UserToPostConnectionPageInfo','CategoryToPostConnectionPageInfo','RootQueryToPostConnectionPageInfo']
    ...
    const TaxonomySEO_possibleTypes: string[] = ['TaxonomySEO']
    export const isTaxonomySEO = (obj?: { __typename?: any } | null): obj is TaxonomySEO => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTaxonomySEO"')
      return TaxonomySEO_possibleTypes.includes(obj.__typename)
    }
    


    const SEOTaxonomySchema_possibleTypes: string[] = ['SEOTaxonomySchema']
    export const isSEOTaxonomySchema = (obj?: { __typename?: any } | null): obj is SEOTaxonomySchema => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOTaxonomySchema"')
      return SEOTaxonomySchema_possibleTypes.includes(obj.__typename)
    }
    ...
    const TermNodeConnectionPageInfo_possibleTypes: string[] = ['PostToTermNodeConnectionPageInfo','RootQueryToTermNodeConnectionPageInfo']
    ...
    const SEOUser_possibleTypes: string[] = ['SEOUser']
    export const isSEOUser = (obj?: { __typename?: any } | null): obj is SEOUser => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOUser"')
      return SEOUser_possibleTypes.includes(obj.__typename)
    }
    


    const SEOUserSchema_possibleTypes: string[] = ['SEOUserSchema']
    export const isSEOUserSchema = (obj?: { __typename?: any } | null): obj is SEOUserSchema => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOUserSchema"')
      return SEOUserSchema_possibleTypes.includes(obj.__typename)
    }
    


    const SEOUserSocial_possibleTypes: string[] = ['SEOUserSocial']
    export const isSEOUserSocial = (obj?: { __typename?: any } | null): obj is SEOUserSocial => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOUserSocial"')
      return SEOUserSocial_possibleTypes.includes(obj.__typename)
    }
    ...
    const MenuItemObjectUnion_possibleTypes: string[] = ['Post','Page','Category','Tag']
    ...
    const SEOConfig_possibleTypes: string[] = ['SEOConfig']
    export const isSEOConfig = (obj?: { __typename?: any } | null): obj is SEOConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOConfig"')
      return SEOConfig_possibleTypes.includes(obj.__typename)
    }
    


    const SEOBreadcrumbs_possibleTypes: string[] = ['SEOBreadcrumbs']
    export const isSEOBreadcrumbs = (obj?: { __typename?: any } | null): obj is SEOBreadcrumbs => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOBreadcrumbs"')
      return SEOBreadcrumbs_possibleTypes.includes(obj.__typename)
    }
    


    const SEOContentTypes_possibleTypes: string[] = ['SEOContentTypes']
    export const isSEOContentTypes = (obj?: { __typename?: any } | null): obj is SEOContentTypes => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOContentTypes"')
      return SEOContentTypes_possibleTypes.includes(obj.__typename)
    }
    


    const SEOContentType_possibleTypes: string[] = ['SEOContentType']
    export const isSEOContentType = (obj?: { __typename?: any } | null): obj is SEOContentType => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOContentType"')
      return SEOContentType_possibleTypes.includes(obj.__typename)
    }
    


    const SEOContentTypeArchive_possibleTypes: string[] = ['SEOContentTypeArchive']
    export const isSEOContentTypeArchive = (obj?: { __typename?: any } | null): obj is SEOContentTypeArchive => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOContentTypeArchive"')
      return SEOContentTypeArchive_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMeta_possibleTypes: string[] = ['SEOGlobalMeta']
    export const isSEOGlobalMeta = (obj?: { __typename?: any } | null): obj is SEOGlobalMeta => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMeta"')
      return SEOGlobalMeta_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMetaAuthor_possibleTypes: string[] = ['SEOGlobalMetaAuthor']
    export const isSEOGlobalMetaAuthor = (obj?: { __typename?: any } | null): obj is SEOGlobalMetaAuthor => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMetaAuthor"')
      return SEOGlobalMetaAuthor_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMetaConfig_possibleTypes: string[] = ['SEOGlobalMetaConfig']
    export const isSEOGlobalMetaConfig = (obj?: { __typename?: any } | null): obj is SEOGlobalMetaConfig => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMetaConfig"')
      return SEOGlobalMetaConfig_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMetaDate_possibleTypes: string[] = ['SEOGlobalMetaDate']
    export const isSEOGlobalMetaDate = (obj?: { __typename?: any } | null): obj is SEOGlobalMetaDate => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMetaDate"')
      return SEOGlobalMetaDate_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMetaHome_possibleTypes: string[] = ['SEOGlobalMetaHome']
    export const isSEOGlobalMetaHome = (obj?: { __typename?: any } | null): obj is SEOGlobalMetaHome => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMetaHome"')
      return SEOGlobalMetaHome_possibleTypes.includes(obj.__typename)
    }
    


    const SEOGlobalMeta404_possibleTypes: string[] = ['SEOGlobalMeta404']
    export const isSEOGlobalMeta404 = (obj?: { __typename?: any } | null): obj is SEOGlobalMeta404 => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOGlobalMeta404"')
      return SEOGlobalMeta404_possibleTypes.includes(obj.__typename)
    }
    


    const SEOOpenGraph_possibleTypes: string[] = ['SEOOpenGraph']
    export const isSEOOpenGraph = (obj?: { __typename?: any } | null): obj is SEOOpenGraph => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOOpenGraph"')
      return SEOOpenGraph_possibleTypes.includes(obj.__typename)
    }
    


    const SEOOpenGraphFrontPage_possibleTypes: string[] = ['SEOOpenGraphFrontPage']
    export const isSEOOpenGraphFrontPage = (obj?: { __typename?: any } | null): obj is SEOOpenGraphFrontPage => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOOpenGraphFrontPage"')
      return SEOOpenGraphFrontPage_possibleTypes.includes(obj.__typename)
    }
    


    const SEORedirect_possibleTypes: string[] = ['SEORedirect']
    export const isSEORedirect = (obj?: { __typename?: any } | null): obj is SEORedirect => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEORedirect"')
      return SEORedirect_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSchema_possibleTypes: string[] = ['SEOSchema']
    export const isSEOSchema = (obj?: { __typename?: any } | null): obj is SEOSchema => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSchema"')
      return SEOSchema_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocial_possibleTypes: string[] = ['SEOSocial']
    export const isSEOSocial = (obj?: { __typename?: any } | null): obj is SEOSocial => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocial"')
      return SEOSocial_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialFacebook_possibleTypes: string[] = ['SEOSocialFacebook']
    export const isSEOSocialFacebook = (obj?: { __typename?: any } | null): obj is SEOSocialFacebook => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialFacebook"')
      return SEOSocialFacebook_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialInstagram_possibleTypes: string[] = ['SEOSocialInstagram']
    export const isSEOSocialInstagram = (obj?: { __typename?: any } | null): obj is SEOSocialInstagram => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialInstagram"')
      return SEOSocialInstagram_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialLinkedIn_possibleTypes: string[] = ['SEOSocialLinkedIn']
    export const isSEOSocialLinkedIn = (obj?: { __typename?: any } | null): obj is SEOSocialLinkedIn => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialLinkedIn"')
      return SEOSocialLinkedIn_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialMySpace_possibleTypes: string[] = ['SEOSocialMySpace']
    export const isSEOSocialMySpace = (obj?: { __typename?: any } | null): obj is SEOSocialMySpace => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialMySpace"')
      return SEOSocialMySpace_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialPinterest_possibleTypes: string[] = ['SEOSocialPinterest']
    export const isSEOSocialPinterest = (obj?: { __typename?: any } | null): obj is SEOSocialPinterest => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialPinterest"')
      return SEOSocialPinterest_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialTwitter_possibleTypes: string[] = ['SEOSocialTwitter']
    export const isSEOSocialTwitter = (obj?: { __typename?: any } | null): obj is SEOSocialTwitter => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialTwitter"')
      return SEOSocialTwitter_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialWikipedia_possibleTypes: string[] = ['SEOSocialWikipedia']
    export const isSEOSocialWikipedia = (obj?: { __typename?: any } | null): obj is SEOSocialWikipedia => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialWikipedia"')
      return SEOSocialWikipedia_possibleTypes.includes(obj.__typename)
    }
    


    const SEOSocialYoutube_possibleTypes: string[] = ['SEOSocialYoutube']
    export const isSEOSocialYoutube = (obj?: { __typename?: any } | null): obj is SEOSocialYoutube => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOSocialYoutube"')
      return SEOSocialYoutube_possibleTypes.includes(obj.__typename)
    }
    


    const SEOWebmaster_possibleTypes: string[] = ['SEOWebmaster']
    export const isSEOWebmaster = (obj?: { __typename?: any } | null): obj is SEOWebmaster => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isSEOWebmaster"')
      return SEOWebmaster_possibleTypes.includes(obj.__typename)
    }
    ...
    const PageTemplateCapabilities_possibleTypes: string[] = ['PageTemplateCapabilities']
    export const isPageTemplateCapabilities = (obj?: { __typename?: any } | null): obj is PageTemplateCapabilities => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateCapabilities"')
      return PageTemplateCapabilities_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateAboutUs_possibleTypes: string[] = ['PageTemplateAboutUs']
    export const isPageTemplateAboutUs = (obj?: { __typename?: any } | null): obj is PageTemplateAboutUs => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateAboutUs"')
      return PageTemplateAboutUs_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateBio_possibleTypes: string[] = ['PageTemplateBio']
    export const isPageTemplateBio = (obj?: { __typename?: any } | null): obj is PageTemplateBio => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateBio"')
      return PageTemplateBio_possibleTypes.includes(obj.__typename)
    }
    


    const Template_BlogDetail_possibleTypes: string[] = ['Template_BlogDetail']
    export const isTemplate_BlogDetail = (obj?: { __typename?: any } | null): obj is Template_BlogDetail => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_BlogDetail"')
      return Template_BlogDetail_possibleTypes.includes(obj.__typename)
    }
    


    const Template_Blog_possibleTypes: string[] = ['Template_Blog']
    export const isTemplate_Blog = (obj?: { __typename?: any } | null): obj is Template_Blog => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_Blog"')
      return Template_Blog_possibleTypes.includes(obj.__typename)
    }
    


    const Template_Build_possibleTypes: string[] = ['Template_Build']
    export const isTemplate_Build = (obj?: { __typename?: any } | null): obj is Template_Build => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_Build"')
      return Template_Build_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateCaseStudy_possibleTypes: string[] = ['PageTemplateCaseStudy']
    export const isPageTemplateCaseStudy = (obj?: { __typename?: any } | null): obj is PageTemplateCaseStudy => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateCaseStudy"')
      return PageTemplateCaseStudy_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateContactUs_possibleTypes: string[] = ['PageTemplateContactUs']
    export const isPageTemplateContactUs = (obj?: { __typename?: any } | null): obj is PageTemplateContactUs => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateContactUs"')
      return PageTemplateContactUs_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateDesignFAQ_possibleTypes: string[] = ['PageTemplateDesignFAQ']
    export const isPageTemplateDesignFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateDesignFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateDesignFAQ"')
      return PageTemplateDesignFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateDiscoveryFAQ_possibleTypes: string[] = ['PageTemplateDiscoveryFAQ']
    export const isPageTemplateDiscoveryFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateDiscoveryFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateDiscoveryFAQ"')
      return PageTemplateDiscoveryFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateFAQ_possibleTypes: string[] = ['PageTemplateFAQ']
    export const isPageTemplateFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateFAQ"')
      return PageTemplateFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateDevelopmentFAQ_possibleTypes: string[] = ['PageTemplateDevelopmentFAQ']
    export const isPageTemplateDevelopmentFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateDevelopmentFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateDevelopmentFAQ"')
      return PageTemplateDevelopmentFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const Template_PageFlexibleContentLayout_possibleTypes: string[] = ['Template_PageFlexibleContentLayout']
    export const isTemplate_PageFlexibleContentLayout = (obj?: { __typename?: any } | null): obj is Template_PageFlexibleContentLayout => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_PageFlexibleContentLayout"')
      return Template_PageFlexibleContentLayout_possibleTypes.includes(obj.__typename)
    }
    


    const Template_GcaptainNew_possibleTypes: string[] = ['Template_GcaptainNew']
    export const isTemplate_GcaptainNew = (obj?: { __typename?: any } | null): obj is Template_GcaptainNew => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_GcaptainNew"')
      return Template_GcaptainNew_possibleTypes.includes(obj.__typename)
    }
    


    const Template_GcaptainLandingPage_possibleTypes: string[] = ['Template_GcaptainLandingPage']
    export const isTemplate_GcaptainLandingPage = (obj?: { __typename?: any } | null): obj is Template_GcaptainLandingPage => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_GcaptainLandingPage"')
      return Template_GcaptainLandingPage_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateGeneralFAQ_possibleTypes: string[] = ['PageTemplateGeneralFAQ']
    export const isPageTemplateGeneralFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateGeneralFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateGeneralFAQ"')
      return PageTemplateGeneralFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const Template_Home_possibleTypes: string[] = ['Template_Home']
    export const isTemplate_Home = (obj?: { __typename?: any } | null): obj is Template_Home => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_Home"')
      return Template_Home_possibleTypes.includes(obj.__typename)
    }
    


    const Template_Slocal_possibleTypes: string[] = ['Template_Slocal']
    export const isTemplate_Slocal = (obj?: { __typename?: any } | null): obj is Template_Slocal => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_Slocal"')
      return Template_Slocal_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplateMarketingFAQ_possibleTypes: string[] = ['PageTemplateMarketingFAQ']
    export const isPageTemplateMarketingFAQ = (obj?: { __typename?: any } | null): obj is PageTemplateMarketingFAQ => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplateMarketingFAQ"')
      return PageTemplateMarketingFAQ_possibleTypes.includes(obj.__typename)
    }
    


    const PageTemplatePrivacyPolicy_possibleTypes: string[] = ['PageTemplatePrivacyPolicy']
    export const isPageTemplatePrivacyPolicy = (obj?: { __typename?: any } | null): obj is PageTemplatePrivacyPolicy => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPageTemplatePrivacyPolicy"')
      return PageTemplatePrivacyPolicy_possibleTypes.includes(obj.__typename)
    }
    


    const Template_Service_possibleTypes: string[] = ['Template_Service']
    export const isTemplate_Service = (obj?: { __typename?: any } | null): obj is Template_Service => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_Service"')
      return Template_Service_possibleTypes.includes(obj.__typename)
    }
    


    const Template_StudyCase_possibleTypes: string[] = ['Template_StudyCase']
    export const isTemplate_StudyCase = (obj?: { __typename?: any } | null): obj is Template_StudyCase => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isTemplate_StudyCase"')
      return Template_StudyCase_possibleTypes.includes(obj.__typename)
    }
...
export const enumMimeTypeEnum = {
   APPLICATION_JAVA: 'APPLICATION_JAVA' as const,
   APPLICATION_MSWORD: 'APPLICATION_MSWORD' as const,
   APPLICATION_OCTET_STREAM: 'APPLICATION_OCTET_STREAM' as const,
   APPLICATION_ONENOTE: 'APPLICATION_ONENOTE' as const,
   APPLICATION_OXPS: 'APPLICATION_OXPS' as const,
   APPLICATION_PDF: 'APPLICATION_PDF' as const,
   APPLICATION_RAR: 'APPLICATION_RAR' as const,
   APPLICATION_RTF: 'APPLICATION_RTF' as const,
   APPLICATION_TTAF_XML: 'APPLICATION_TTAF_XML' as const,
   APPLICATION_VND_APPLE_KEYNOTE: 'APPLICATION_VND_APPLE_KEYNOTE' as const,
   APPLICATION_VND_APPLE_NUMBERS: 'APPLICATION_VND_APPLE_NUMBERS' as const,
   APPLICATION_VND_APPLE_PAGES: 'APPLICATION_VND_APPLE_PAGES' as const,
   APPLICATION_VND_MS_ACCESS: 'APPLICATION_VND_MS_ACCESS' as const,
   APPLICATION_VND_MS_EXCEL: 'APPLICATION_VND_MS_EXCEL' as const,
   APPLICATION_VND_MS_EXCEL_ADDIN_MACROENABLED_12: 'APPLICATION_VND_MS_EXCEL_ADDIN_MACROENABLED_12' as const,
   ...
   APPLICATION_VND_MS_EXCEL_TEMPLATE_MACROENABLED_12: 'APPLICATION_VND_MS_EXCEL_TEMPLATE_MACROENABLED_12' as const,
   APPLICATION_VND_MS_POWERPOINT: 'APPLICATION_VND_MS_POWERPOINT' as const,
   APPLICATION_VND_MS_POWERPOINT_ADDIN_MACROENABLED_12: 'APPLICATION_VND_MS_POWERPOINT_ADDIN_MACROENABLED_12' as const,
   ...
   APPLICATION_VND_MS_POWERPOINT_SLIDE_MACROENABLED_12: 'APPLICATION_VND_MS_POWERPOINT_SLIDE_MACROENABLED_12' as const,
   APPLICATION_VND_MS_POWERPOINT_TEMPLATE_MACROENABLED_12: 'APPLICATION_VND_MS_POWERPOINT_TEMPLATE_MACROENABLED_12' as const,
   APPLICATION_VND_MS_PROJECT: 'APPLICATION_VND_MS_PROJECT' as const,
   APPLICATION_VND_MS_WORD_DOCUMENT_MACROENABLED_12: 'APPLICATION_VND_MS_WORD_DOCUMENT_MACROENABLED_12' as const,
   APPLICATION_VND_MS_WORD_TEMPLATE_MACROENABLED_12: 'APPLICATION_VND_MS_WORD_TEMPLATE_MACROENABLED_12' as const,
   APPLICATION_VND_MS_WRITE: 'APPLICATION_VND_MS_WRITE' as const,
   APPLICATION_VND_MS_XPSDOCUMENT: 'APPLICATION_VND_MS_XPSDOCUMENT' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_CHART: 'APPLICATION_VND_OASIS_OPENDOCUMENT_CHART' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_DATABASE: 'APPLICATION_VND_OASIS_OPENDOCUMENT_DATABASE' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_FORMULA: 'APPLICATION_VND_OASIS_OPENDOCUMENT_FORMULA' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_GRAPHICS: 'APPLICATION_VND_OASIS_OPENDOCUMENT_GRAPHICS' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_PRESENTATION: 'APPLICATION_VND_OASIS_OPENDOCUMENT_PRESENTATION' as const,
   APPLICATION_VND_OASIS_OPENDOCUMENT_SPREADSHEET: 'APPLICATION_VND_OASIS_OPENDOCUMENT_SPREADSHEET' as const,
   ...
   APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDE: 'APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_SLIDE' as const,
   ...
   APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TEMPLATE: 'APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_PRESENTATIONML_TEMPLATE' as const,
   ...
   APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TEMPLATE: 'APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_SPREADSHEETML_TEMPLATE' as const,
   ...
   APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_TEMPLATE: 'APPLICATION_VND_OPENXMLFORMATS_OFFICEDOCUMENT_WORDPROCESSINGML_TEMPLATE' as const,
   APPLICATION_WORDPERFECT: 'APPLICATION_WORDPERFECT' as const,
   APPLICATION_X_7Z_COMPRESSED: 'APPLICATION_X_7Z_COMPRESSED' as const,
   APPLICATION_X_GZIP: 'APPLICATION_X_GZIP' as const,
   APPLICATION_X_TAR: 'APPLICATION_X_TAR' as const,
   APPLICATION_ZIP: 'APPLICATION_ZIP' as const,
   AUDIO_AAC: 'AUDIO_AAC' as const,
   ...
   AUDIO_X_MATROSKA: 'AUDIO_X_MATROSKA' as const,
   AUDIO_X_MS_WAX: 'AUDIO_X_MS_WAX' as const,
   AUDIO_X_MS_WMA: 'AUDIO_X_MS_WMA' as const,
   AUDIO_X_REALAUDIO: 'AUDIO_X_REALAUDIO' as const,
   IMAGE_BMP: 'IMAGE_BMP' as const,
   IMAGE_GIF: 'IMAGE_GIF' as const,
   IMAGE_HEIC: 'IMAGE_HEIC' as const,
   IMAGE_JPEG: 'IMAGE_JPEG' as const,
   IMAGE_PNG: 'IMAGE_PNG' as const,
   IMAGE_TIFF: 'IMAGE_TIFF' as const,
   IMAGE_WEBP: 'IMAGE_WEBP' as const,
   IMAGE_X_ICON: 'IMAGE_X_ICON' as const,
   TEXT_CALENDAR: 'TEXT_CALENDAR' as const,
   TEXT_CSS: 'TEXT_CSS' as const,
   TEXT_CSV: 'TEXT_CSV' as const,
   TEXT_PLAIN: 'TEXT_PLAIN' as const,
   TEXT_RICHTEXT: 'TEXT_RICHTEXT' as const,
   TEXT_TAB_SEPARATED_VALUES: 'TEXT_TAB_SEPARATED_VALUES' as const,
   TEXT_VTT: 'TEXT_VTT' as const,
   VIDEO_3GPP: 'VIDEO_3GPP' as const,
   VIDEO_3GPP2: 'VIDEO_3GPP2' as const,
   VIDEO_AVI: 'VIDEO_AVI' as const,
   VIDEO_DIVX: 'VIDEO_DIVX' as const,
   ...
   VIDEO_X_MATROSKA: 'VIDEO_X_MATROSKA' as const,
   VIDEO_X_MS_ASF: 'VIDEO_X_MS_ASF' as const,
   VIDEO_X_MS_WM: 'VIDEO_X_MS_WM' as const,
   VIDEO_X_MS_WMV: 'VIDEO_X_MS_WMV' as const,
   VIDEO_X_MS_WMX: 'VIDEO_X_MS_WMX' as const
}
...
export const enumSeoCardType = {
   summary: 'summary' as const,
   summary_large_image: 'summary_large_image' as const
}
